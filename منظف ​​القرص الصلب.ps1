...
#GUI Variables
$FormTitleText = "منظف القرص بواسطة Jim Tyler (PowerShellEngineer.com)"
$SelectDiskLabelText = "حدد القرص:"
$FreeSpaceLabelText = "مساحة حرة (غيغابايت):"
$TotalSpaceLabelText = "المساحة الإجمالية (غيغابايت):"
$JunkFoundLabelText = "تم العثور على القمامة (غيغابايت):"
$CleanDiskBtnText = "تنظيف القرص * حذف الملفات *"
$SpaceCleanedLabelText = "تم تنظيف المساحة (غيغابايت):"
$LogFileLabelText = "موقع ملف السجل: $abcdefg"
$CreditLabelText = "برنامج نصي بواسطة Jim Tyler - PowerShellEngineer.com"
$LogFileLocatedText = "ملف السجل موجود"
$AnalyzingDriveText = "جارٍ تحليل محركات الأقراص ..."
$BrowsersAreRunningText = "المتصفحات قيد التشغيل ... إخطار المستخدم ..."
$PleaseCloseBrowsersText = "الرجاء إغلاق كافة متصفحات الويب والمحاولة مرة أخرى."
$CleaningDriveText = "تنظيف محرك الأقراص ..."
